    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <p class="footer-text"><i class="fas fa-envelope"></i> emnayon@Yahoo.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
                <h3 class="service-card-title">তথ্য </h3>
                <hr>
                <a class="footer-link"   href="{{url('contact')}}">যোগাযোগ</a><br>
                <a class="footer-link"  href="#project">প্রজেক্ট সমূহ</a><br>
                <a class="footer-link"   href="#course">কোর্স সমূহ </a><br>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
                <h3 class="service-card-title">আইনি</h3>
                <hr>
                <a class="footer-link" target="_blank" href="{{url('policy')}}">প্রাইভেচি পলিসি </a><br>
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব ইমরান মাসুদ দ্বারা সংরক্ষিত; ২০২৩-২০২৪ </p>
</div>
